...
public class CameraMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        targetPosition.x = followTarget.position.x;// + offset.x;
        targetPosition.y = followTarget.position.y;// + offset.y;
    ...
    void LateUpdate()
    {
        ...
        Vector3 targetPos = new Vector3(targetPosition.x, targetPosition.y, cam.transform.position.z) + offsetView;
    ...
    Vector3 VIewAhead()
    {
        ...
        if (longPressTimer > 3f)
        {
            ...
            onPlayer = false;
            offsetCam.x = (isLeft) ? horizontalView - 1.8f : horizontalView + 1.8f;
            offsetCam.y = (isDown) ? verticalView - 1.2f : verticalView + 1.2f;
            longPressTimer = 0f;
